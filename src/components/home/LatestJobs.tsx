...
export default async function LatestJobsOpen() {
  ...
  return (
    <Container className="mt-8 md:mt-16 bg-background">
      {/* Header */}
      <div className="flex items-center justify-between mb-8 md:mb-12">
        ...
        <Link
          href="/jobs"
          className="hidden md:flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-foreground transition"
        >
          Show All
